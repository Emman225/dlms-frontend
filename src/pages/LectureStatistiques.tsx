...
export default function LectureStatistiques() {
      ...
      <div className="content content-full">
        ...
        <div className="block block-rounded">
          <div className="block-header block-header-default">
            <h3 className="block-title">Statistiques</h3>
          </div>
          <div className="block-content">
            {/* TODO: Implémenter graphiques/statistiques si backend disponible */}
            <p className="text-muted mb-0">Statistiques des lectures (à implémenter).</p>
          </div>
        </div>
      </div>
    </MainLayout>
